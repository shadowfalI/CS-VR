...
public class fps_FPInput : MonoBehaviour {
    ...
    {
        LockCursor = true;
        parameter = gameObject.GetComponent<fps_PlayerParameter>();
        input = GameObject.FindGameObjectWithTag(Tags.gameController).GetComponent<fps_Input>();

		//input = GameObject.Find("Right Controller").GetComponent<fps_Input>();
    ...
    private void InitialInput()
    {
        ...
        parameter.inputJump = input.GetButtonDown("Jump");
        parameter.inputSprint = input.GetButtonDown("Sprint");
